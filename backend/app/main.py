...
from app.routers import audit, auth, bd, business_admin, delegations, loi, notifications, sites, staging, tenancy, users
...
for router_module in (auth, bd, loi, staging, sites, audit, notifications, tenancy, users, delegations, business_admin):
