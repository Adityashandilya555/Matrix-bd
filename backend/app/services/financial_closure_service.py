...
async def _build_fc_state(
    ...
    return FCStateResponse(
        ...
        # Canonical rent (read-only). Pydantic coerces the Decimal columns to float.
        rent_type=site.rent_type,
        expected_rent=site.expected_rent,
        expected_revshare_pct=site.expected_revshare_pct,
        revshare_dinein_pct=site.revshare_dinein_pct,
        revshare_delivery_pct=site.revshare_delivery_pct,
        expected_escalation_pct=site.expected_escalation_pct,
