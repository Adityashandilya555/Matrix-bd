...
export const Icon = {
  ...
  grid:    (p) => <Svg {...p}><rect x="4" y="4" width="6.5" height="6.5" rx="1"/><rect x="13.5" y="4" width="6.5" height="6.5" rx="1"/><rect x="4" y="13.5" width="6.5" height="6.5" rx="1"/><rect x="13.5" y="13.5" width="6.5" height="6.5" rx="1"/></Svg>,
  trend:   (p) => <Svg {...p}><path d="M4 4v16h16"/><path d="m8 14 3-3 3.5 3.5L19 9"/></Svg>,
  box:     (p) => <Svg {...p}><path d="m3 9 9-5.5L21 9l-9 5.5L3 9Z"/><path d="M3 9v6l9 5.5 9-5.5V9"/></Svg>,
  home:    (p) => <Svg {...p}><path d="m4 10 8-6.5L20 10v9a1.5 1.5 0 0 1-1.5 1.5h-4V14h-5v6.5h-4A1.5 1.5 0 0 1 4 19v-9Z"/></Svg>,
