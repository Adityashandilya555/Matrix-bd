...
export const ROUTES = {
  ...
  PROJECT_EXCELLENCE_OVERVIEW:      '/project-excellence/overview',
  PROJECT_EXCELLENCE_HISTORY:       '/project-excellence/history',
  PROJECT_EXCELLENCE_QUALITY_AUDIT: '/project-excellence/quality-audit',
...
export const PRODUCT_NAME = 'Retail Expansion';
